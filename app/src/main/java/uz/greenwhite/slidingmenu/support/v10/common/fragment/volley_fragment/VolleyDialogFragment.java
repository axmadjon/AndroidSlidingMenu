...
public class VolleyDialogFragment extends DialogFragment implements VolleySupport {
    ...
    public void onActivityResult(boolean hasFragment, int requestCode, int resultCode, Intent data) {
