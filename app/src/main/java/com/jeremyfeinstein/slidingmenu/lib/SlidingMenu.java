...
public class SlidingMenu extends RelativeLayout {
    ...
    public interface OnSlidingListener {
        void onListening(int position, float positionOffset,
    ...
    public SlidingMenu(Context context, AttributeSet attrs, int defStyle) {
        ...
        mViewAbove.setOnPageChangeListener(new OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset,
                                       int positionOffsetPixels) {//TODO
                slidingListener.onListening(position, positionOffset, positionOffsetPixels);
            }
    ...
    public void setOnSlidingListener(OnSlidingListener slidingListener) {
    ...
    public void setBehindOffsetInt(int pos) {
        setBehindOffset(pos);
    }
